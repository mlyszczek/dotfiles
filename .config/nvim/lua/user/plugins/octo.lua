return {
	...
	config = function ()
		require"octo".setup({
			...
			default_merge_method = "rebase",         -- default merge method which should be used when calling `Octo pr merge`, could be `commit`, `rebase` or `squash`
			...
			mappings = {
				...
				pull_request = {
					...
					rebase_and_merge_pr =  {lhs = "<leader>Gprm",   desc = "rebase and merge PR" },
					...
					react_laugh =          {lhs = "<leader>Grl",    desc = "add/remove 😄 reaction" },
					react_confused =       {lhs = "<leader>Grc",    desc = "add/remove 😕 reaction" },
					review_start =         {lhs = "<leader>Gvs",    desc = "start a review for the current PR" },
					review_resume =        {lhs = "<leader>Gvr",    desc = "resume a pending review for the current PR" },
				},
				review_thread = {
					goto_issue =           {lhs = "<leader>Ggi",    desc = "navigate to a local repo issue" },
					add_comment =          {lhs = "<leader>Gca",    desc = "add comment" },
				...
				review_diff = {
					...
					select_last_entry =     {lhs = "]Q",            desc = "move to last changed file" },
					close_review_tab =      {lhs = "<C-c>",         desc = "close review tab" },
					toggle_viewed =         {lhs = "<leader><leader>G", desc = "toggle viewer viewed state" },
					goto_file =             {lhs = "gf",            desc = "go to file" },
				},
				file_panel = {
					submit_review =         {lhs = "<leader>vs",    desc = "submit review" },
