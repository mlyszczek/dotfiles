return {
	...
	opts = {
		...
		max_height = 60, -- max height of signature floating_window, include borders
		max_width = function()
		...
		-- }
		hint_scheme = "String",
		hint_inline = function() return 'inline' end,  -- should the hint be inline(nvim 0.10 only)?  default false
